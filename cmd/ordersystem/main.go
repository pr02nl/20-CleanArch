...
import (
	...
	"github.com/pr02nl/20-CleanArch/configs"
	"github.com/pr02nl/20-CleanArch/internal/event/handler"
	"github.com/pr02nl/20-CleanArch/internal/infra/graph"
	"github.com/pr02nl/20-CleanArch/internal/infra/grpc/pb"
	"github.com/pr02nl/20-CleanArch/internal/infra/grpc/service"
	"github.com/pr02nl/20-CleanArch/internal/infra/web/webserver"
...
func main() {
	...
	rabbitMQChannel := getRabbitMQChannel(configs.RMQUser, configs.RMQPassword, configs.RMQHost, configs.RMQPort)
...
func getRabbitMQChannel(rmqUser, rmqPassword, rmqHost, rmqPort string) *amqp.Channel {
